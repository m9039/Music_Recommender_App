...
public class Song {
    public Song(Integer id, String song, String artist, String album, Integer yearProduced, String genre, Integer rating, String website, Integer image, Integer spotify) {
        this.id = id;
        this.song = song;
        this.artist = artist;
        this.album = album;
    ...
    public static ArrayList<Song> getSongs() {
        ...
        songs.add(new Song(8, "Every Kind Of Way", "H.E.R.", "H.E.R. Volume 2", 2017, "R&B/Soul", 4,"https://genius.com/Her-every-kind-of-way-lyrics", R.drawable.everykindofway_her, R.drawable.her));
        songs.add(new Song(9, "3005", "Childish Gambino", "Because The Internet", 2013, "Hip-Hop/Rap", 5,"https://genius.com/Childish-gambino-v-3005-lyrics", R.drawable.v3005_childishgambino, R.drawable.childishgambino));
        songs.add(new Song(10, "As Long As You Love Me", "Justin Bieber", "Believe", 2012, "Pop", 4,"https://genius.com/Justin-bieber-as-long-as-you-love-me-lyrics", R.drawable.aslongasyouloveme_justinbieber, R.drawable.justinbieber));
